...
init_repos() {
    ...
    mkdir -p "$LOCAL_REPOS_DIR/core"
    mkdir -p "$LOCAL_REPOS_DIR/observers" 
    mkdir -p "$LOCAL_REPOS_DIR/ui"
    mkdir -p "$LOCAL_REPOS_DIR/services"
    ...
    echo "   • $LOCAL_REPOS_DIR/core/          - ASM Core Services"
    echo "   • $LOCAL_REPOS_DIR/observers/     - Observer Components"
    echo "   • $LOCAL_REPOS_DIR/ui/            - ASM UI Components"
    echo "   • $LOCAL_REPOS_DIR/services/      - Backend Services"
    echo "   • $LOCAL_REPOS_DIR/infrastructure/ - Deployment & Config"
    echo "   • $LOCAL_REPOS_DIR/documentation/ - Documentation Repos"
    echo ""
